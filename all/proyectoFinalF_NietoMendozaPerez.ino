...
int correccionSPL(int decibelesMedidos){
  ...
  void audioOut(){
  // afunciones tda 
  tda.setInput(1); //         int 1...2 ////
  tda.inputGain(5); //        int 0...15  //// 
  tda.setVolume(45); //       int 0...47   //// 
  tda.setBass(0); //          int -7...+7  //// 
  tda.setTreble(0); //        int -7...+7  //// 
  tda.setAttL(0); //          int 0...8  
  tda.setAttR(0); //          int 0...8    
  }

  void audioGain(){
  tda.setInput(1); //         int 1...2 ////
  tda.inputGain(7); //        int 0...15  //// 
  tda.setVolume(47); //       int 0...47   //// 
  tda.setBass(0); //          int -7...+7  //// 
  tda.setTreble(0); //        int -7...+7  //// 
  tda.setAttL(0); //          int 0...8  
  tda.setAttR(0); //          int 0...8    
  ...
  void audioDim(){
  tda.setInput(1); //         int 1...2 ////
  tda.inputGain(0); //        int 0...15  //// 
  tda.setVolume(10); //       int 0...47   //// 
  tda.setBass(0); //          int -7...+7  //// 
  tda.setTreble(0); //        int -7...+7  //// 
  tda.setAttL(0); //          int 0...8  
  tda.setAttR(0); //          int 0...8    
